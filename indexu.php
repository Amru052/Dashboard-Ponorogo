                      ...
                      <div class="form-row">
                        ...
                        <div class="row">
                          <div class="col-md-6 mb-3">
                            <label for="validationCustom01">Rincian 2</label>
                        ...
                        <div class="row">
                          <div class="col-md-6 mb-3">
                            <label for="validationCustom01">Rincian 3</label>
                            <input type="text" class="form-control" name="rincian[]" placeholder="">
                              <div class="valid-feedback">
                                Looks good!
                              </div>
                        ...
                        <div class="row">
                          <div class="col-md-6 mb-3">
                            <label for="validationCustom01">Rincian 4</label>
                            <input type="text" class="form-control" name="rincian[]" placeholder="">
                              <div class="valid-feedback">
                                Looks good!
                              </div>
                        ...
                        <div class="row">
                          <div class="col-md-6 mb-3">
                            <label for="validationCustom01">Rincian 5</label>
                            <input type="text" class="form-control" name="rincian[]" placeholder="">
                              <div class="valid-feedback">
                                Looks good!
                              </div>
